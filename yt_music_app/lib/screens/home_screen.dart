...
class _HomeScreenState extends State<HomeScreen> {
  ...
  List<Widget> _buildSliverList(SongProvider songProvider, List<Song> results) {
                      ...
                      child: Row(
                        children: [
                          ...
                          TextButton(
                            ...
                            child: const Text('ล้าง', style: TextStyle(color: Color(0xFF777777), fontSize: 12)),
                          ),
                        ],
                      ),
                    ),
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return GestureDetector(
                            onTap: () => songProvider.playSong(song, queue: songProvider.history, index: songProvider.history.indexOf(song)),
                            child: Container(
                              width: 150,
    ...
    if (_selectedIndex == 0 && results.isNotEmpty) {
      ...
      final filteredResults = results.where((s) => s.id != currentSong?.id).toList();
  ...
  Widget _buildNowPlayingSection(SongProvider songProvider, List<Song> results) {
    final hPad = Responsive.hPadding(context);
    final currentSong = songProvider.currentSong;
